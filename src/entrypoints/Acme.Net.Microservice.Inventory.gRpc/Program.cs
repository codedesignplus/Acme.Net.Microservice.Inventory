...
using Acme.Net.Microservice.Inventory.gRpc.Services;
...
builder.Services.AddMediatR<Acme.Net.Microservice.Inventory.Application.Startup>();
builder.Services.AddFluentValidation();

builder.Services.AddMongo<Acme.Net.Microservice.Inventory.Infrastructure.Startup>(builder.Configuration);
builder.Services.AddRedis(builder.Configuration);
builder.Services.AddRabbitMQ<Acme.Net.Microservice.Inventory.Domain.Startup>(builder.Configuration);
...
app.MapGrpcService<InventoryService>().RequireAuthorization();
