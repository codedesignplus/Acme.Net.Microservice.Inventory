...
[EventKey<InventoryAggregate>(1, "InventoryUpdatedDomainEvent")]
public class InventoryUpdatedDomainEvent(
    Guid aggregateId,
    string name,
    string code,
...
) : DomainEvent(aggregateId, eventId, occurredAt, metadata)
{
    ...
    public static InventoryUpdatedDomainEvent Create(
        Guid aggregateId,
        string name,
        string code,
        List<ProductEntity> products,
        ...
        long? updatedAt)
    {
        return new InventoryUpdatedDomainEvent(
            aggregateId,
            name,
            code,
            products,
